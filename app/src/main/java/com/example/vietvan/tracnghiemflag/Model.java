...
public class Model {
    ...
    public static List<FlagResponse> getListCountryinAsean(List<FlagResponse> list){
        ...
        for(FlagResponse flagResponse : list)
            if(flagResponse.getRegionalBlocs().size() != 0 && flagResponse.getRegionalBlocs().get(0).getAcronym().equals("ASEAN"))
    ...
    public static List<String> getAnswerImage(List<FlagResponse> list, int pos){
        HashSet<String> hashSet = new HashSet<>();
