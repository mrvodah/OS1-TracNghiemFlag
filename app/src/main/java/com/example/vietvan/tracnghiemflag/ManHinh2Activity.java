...
//            SvgLoader.pluck()
//                    .with(this)
//                    .load(flag.getFlag(), iv);

            SvgLoader.pluck()
                    .with(this)
                    .load(flagResponseList.get(0), ivAnh1);
            SvgLoader.pluck()
                    .with(this)
                    .load(flagResponseList.get(1), ivAnh2);
            SvgLoader.pluck()
                    .with(this)
                    .load(flagResponseList.get(2), ivAnh3);
            SvgLoader.pluck()
                    .with(this)
                    .load(flagResponseList.get(3), ivAnh4);
        ...
        switch (view.getId()) {
            case R.id.ivAnh1:
                if(!isClick){
                    ...
                    isClick = true;
                    ++position;
                    if (flag.getFlag().equals(flagResponseList.get(0))) {
                        loadDiem();
                        loadMusic(true);
                    }
                    else{
            ...
            case R.id.ivAnh2:
                if(!isClick){
                    ...
                    isClick = true;
                    ++position;
                    if (flag.getFlag().equals(flagResponseList.get(1))) {
                        loadDiem();
                        loadMusic(true);
                    }
                    else{
            ...
            case R.id.ivAnh3:
                if(!isClick){
                    ...
                    isClick = true;
                    ++position;
                    if (flag.getFlag().equals(flagResponseList.get(2))) {
                        loadDiem();
                        loadMusic(true);
                    }
                    else{
            ...
            case R.id.ivAnh4:
                if(!isClick){
                    ...
                    isClick = true;
                    ++position;
                    if (flag.getFlag().equals(flagResponseList.get(3))) {
                        loadDiem();
                        loadMusic(true);
                    }
                    else{
